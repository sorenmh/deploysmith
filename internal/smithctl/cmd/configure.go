...
var configureCmd = &cobra.Command{
	Use:   "configure",
	Short: "Configure smithctl settings interactively",
	Long: `Configure smithctl settings interactively or via command line flags.
...
This configuration is shared with forge for convenience.

Example:
  smithctl configure
  smithctl configure --url https://smithd.example.com --api-key sk_live_abc123`,
	RunE: runConfigure,
}
